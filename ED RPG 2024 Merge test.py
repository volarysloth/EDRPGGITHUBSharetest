...
SmallGimballedPulseLaserA = 15*2 # the laser dammage here is 10+5 against shields. Later it shoudl be changed to incorporate hull and shield cases.
...
ShieldA = 35 # sidewinder was taken as basis.
ShieldB = 35
...
def shieldrecharge():
    ...
    if  ShieldA < ShieldAf-5:
        ShieldA = ShieldA + 5
    else: ShieldA = ShieldAf
    print ('ShieldA was partially charged. Its new value is ', ShieldA )

    # we do not take care of ship B on what is considered to be a shield recharge. Only Player characters ships shield
    # is being recharged as it seems.

    if  ShieldB < ShieldBf-5:
        ShieldB = ShieldB + 5
    else: ShieldB = ShieldBf
    print ('ShieldB was partially charged. Its new value is ', ShieldB )
